...
// User preferences and localStorage management
const UserPreferences = {
    init() {
        ...
        // Initialize save preferences button
        this.initSavePreferences();
    },
...
const AnimationManager = {
    ...
    initScrollAnimations() {
        const animateOnScroll = () => {
            const elements = document.querySelectorAll('.keyboardsgal img, .hero, .contact-section');
    ...
    initHoverAnimations() {
        const buttons = document.querySelectorAll('button:not(#themeToggle):not(#savePreferences)');
        buttons.forEach(button => {
            button.addEventListener('mouseenter', () => {
                button.classList.add('animate-rotate-in');
            });
            button.addEventListener('mouseleave', () => {
                button.classList.remove('animate-rotate-in');
            });
        });
    }
}; 